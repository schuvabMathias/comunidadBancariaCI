                    ...
                    <div class="container mt-4">
                        ...
                        <?php if ($_SESSION['tipo_usuario'] == 0) { ?>
                            <div class="d-grid mt-3">
                                <a type="button" class="btn btn-lg botoncitoPlus" href="<?php echo base_url() ?>/index.php/bancoController/create">Crear banco</a>
                            </div>
                        <?php } ?>
                        <div class="d-grid mt-3">
                            <a type="button" class="btn btn-lg botoncitoPlus" href="<?php echo base_url() ?>/index.php/bancoController/mostrar">Mostrar bancos</a>
                        </div>
                    </div>
                </div>
            </main>
