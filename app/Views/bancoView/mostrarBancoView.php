                    ...
                    <tbody class="table-group-divider">
                        <?php for ($i = 0; $i < sizeof($bancos); $i++) { ?>
                            <tr>
                                ...
                                <td>
                                    <a href="<?php echo base_url() ?>/index.php/bancoController/mostrarSucursales/<?php echo $bancos[$i]['nombre'] ?>">
                                ...
                                <?php if ($_SESSION['tipo_usuario'] == 0) { ?>
                                    <td>
                                        <a href="<?php echo base_url() ?>/index.php/clienteController/mostrarClientesSegunBanco/<?php echo $bancos[$i]['id_banco'] ?>">
                                    ...
                                    <td>
                                        <a href="<?php echo base_url() ?>/index.php/bancoController/update/<?php echo $bancos[$i]['id_banco'] ?>">
                                    ...
                                    <td>
                                        <a href="<?php echo base_url() ?>/index.php/bancoController/delete/<?php echo $bancos[$i]['id_banco'] ?>">
