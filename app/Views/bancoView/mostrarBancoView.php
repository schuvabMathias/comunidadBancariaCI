        ...
        <div class="container menuInfo d-flex  flex-column flex-md-row">
            ...
            <main class="container informacion flex-grow-1">
                <div class="container tituloTwo">
                    <h3>Menú Banco > Mostrar Bancos</h3>
                </div>
                        ...
                        <div class="row">
                            <div class="col-3 mb-3 form-floating">
                                <select class="form-select" aria-label="Select Forma" name="selectForma" id="selectForma">
                                    ...
                                    <option value="numero_sucursal">Número de Sucursal</option>
                                </select>
                                <label class="form-label" for="selectForma">Buscar por:</label>
                            </div>
                            <div class="col-7 mb-1 form-floating">
                            ...
                            <tbody class="table-group-divider">
                                <?php for ($i = 0; $i < sizeof($bancos); $i++) { ?>
                                    <tr>
                                        ...
                                        <td>
                                            <?php echo $bancos[$i]['direccion'] ?>
                                        </td>
                                        <td>
                                            <?php echo $bancos[$i]['numero_sucursal'] ?>
                                        </td>
                                        <td>
                                            <a href="http://localhost/comunidadBancariaCI/index.php/bancoController/mostrarSucursales/<?php echo $bancos[$i]['nombre'] ?>">
                                        ...
                                        <?php if ($_SESSION['tipo_usuario'] == 0) { ?>
                                            <td>
                                                <a href="http://localhost/comunidadBancariaCI/index.php/clienteController/mostrarClientesSegunBanco/<?php echo $bancos[$i]['id_banco'] ?>">
                                            ...
                                            <td>
                                                <a href="http://localhost/comunidadBancariaCI/index.php/bancoController/update/<?php echo $bancos[$i]['id_banco'] ?>">
                                            ...
                                            <td>
                                                <a href="http://localhost/comunidadBancariaCI/index.php/bancoController/delete/<?php echo $bancos[$i]['id_banco'] ?>">
