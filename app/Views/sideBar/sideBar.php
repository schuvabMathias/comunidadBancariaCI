            ...
            <nav class="navbar navbar-expand-md navbar-light d-flex flex-md-column">
                ...
                <div class="collapse navbar-collapse w-100" id="navbarSupportedContent">
                    <ul class="navbar-nav w-100 d-flex flex-md-column text-center text-md-end">
                        ...
                        <!-- MI CUENTA -->
                        <li>
                            <a href="<?php echo base_url() ?>/index.php/cuentaController/create" class="nav-link"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-coin" viewBox="0 0 16 16">
                        ...
                        <!-- BANCOS -->
                        <li>
                            <a href="<?php echo base_url() ?>/index.php/bancoController/create" class="nav-link"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-bank" viewBox="0 0 16 16">
