                    ...
                    <tbody class="table-group-divider">
                        <?php for ($i = 0; $i < sizeof($cuentas); $i++) { ?>
                            <tr>
                                ...
                                <td>
                                    <a href="<?php echo base_url() ?>/index.php/cuentaController/update/<?php echo $cuentas[$i]['id_cuenta'] ?>">
                                ...
                                <td>
                                    <a href="<?php echo base_url() ?>/index.php/cuentaController/delete/<?php echo $cuentas[$i]['id_cuenta'] ?>">
