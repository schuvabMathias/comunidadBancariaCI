        ...
        <div class="container menuInfo d-flex  flex-column flex-md-row">
            ...
            <main class="container informacion flex-grow-1">
                <div class="container tituloTwo">
                    <h3>Menú Cliente > Mostrar clientes</h3>
                </div>
                                ...
                                <tbody class="table-group-divider">
                                    <?php for ($i = 0; $i < sizeof($clientes); $i++) { ?>
                                        <tr>
                                            ...
                                            <?php if ($_SESSION['tipo_usuario'] == 0) { ?>
                                                <td>
                                                    <a href="http://localhost/comunidadBancariaCI/index.php/cuentaController/mostrarCuentasSegunCliente/<?php echo $clientes[$i]['id_cliente'] ?>">
                                                ...
                                                <td>
                                                    <a href="http://localhost/comunidadBancariaCI/index.php/clienteController/update/<?php echo $clientes[$i]['id_cliente'] ?>">
