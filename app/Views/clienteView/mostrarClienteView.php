            ...
            <tbody class="table-group-divider">
                <?php for ($i = 0; $i < sizeof($clientes); $i++) { ?>
                    <tr>
                        ...
                        <td>
                            <a href="http://localhost/comunidadBancariaCI/index.php/clienteController/modificar">
                        ...
                        <td>
                            <a href="http://localhost/comunidadBancariaCI/index.php/clienteController/delete">
