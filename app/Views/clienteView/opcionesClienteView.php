                ...
                <div class=" justify-content-center ">
                    <div class="container mt-4">
                        ...
                        <div class="d-grid mt-3">
                            <a type="button" class="btn btn-lg botoncitoPlus" href="<?php echo base_url() ?>/index.php/clienteController/create">Crear cliente</a>
                        </div>
                        <div class="d-grid mt-3">
                            <a type="button" class="btn btn-lg botoncitoPlus" href="<?php echo base_url() ?>/index.php/clienteController/mostrar">Mostrar clientes</a>
                        </div>
                    </div>
                </div>
            </main>
