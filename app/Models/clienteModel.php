...
class clienteModel extends Model
{
    ...
    protected $allowedFields = ['nombre_apellido', 'direccion', 'telefono', 'fecha_nacimiento', 'dni', 'cuit_cuil', 'id_usuario']; //Nos permite cambiar los campos que tengan estos nombre. Si no están acá no se podrán manipular
